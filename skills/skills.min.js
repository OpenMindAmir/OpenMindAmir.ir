const icons={github:`
    ...
    `,tr:`
    <svg viewBox="0 0 512 512"><mask id="SVGuywqVbel"><circle cx="256" cy="256" r="256" fill="#fff"/></mask><g mask="url(#SVGuywqVbel)"><path fill="#d80027" d="M0 0h512v512H0z"/><g fill="#eee"><path d="m350 182l33 46l54-18l-33 46l33 46l-54-18l-33 46v-57l-54-17l54-18z"/><path d="M260 370a114 114 0 1 1 54-215a141 141 0 1 0 0 202c-17 9-35 13-54 13"/></g></g></svg>
    `,go:`
    ...
    `,sqlmodel:`
    <svg viewBox="0 0 48 48">
        <path fill="#7e56c2" d="M8.026 5.935c-1.286 1.315-1.286 2.815 0 4.13c.757.774 1.926 1.54 3.488 2.215C14.633 13.63 19.046 14.5 24 14.5s9.367-.871 12.486-2.22c1.562-.675 2.73-1.441 3.488-2.215c1.286-1.315 1.286-2.815 0-4.13c-.757-.774-1.926-1.54-3.488-2.215C33.367 2.37 28.954 1.5 24 1.5s-9.367.871-12.486 2.22c-1.562.675-2.73 1.441-3.488 2.215" />
        <path fill="#7e56c2" fill-rule="evenodd" d="M3.997 8.001L4 7.954V8c0 1.607.76 3.016 1.881 4.163c1.116 1.14 2.656 2.098 4.442 2.87C13.9 16.58 18.736 17.5 24 17.5s10.1-.92 13.677-2.466c1.786-.773 3.326-1.73 4.441-2.871C43.24 11.016 44 9.567 44 7.96l.076 1.335c.047.88.11 2.136.173 3.643c.107 2.566.214 5.865.243 9.277c-.128 1.764-1.829 3.796-5.556 5.49C35.19 29.409 29.91 30.5 24 30.5s-11.19-1.092-14.936-2.794c-3.727-1.695-5.428-3.727-5.556-5.49c.03-3.413.136-6.712.243-9.278A310 310 0 0 1 3.997 8M8.5 22a2 2 0 1 1 4 0a2 2 0 0 1-4 0m8.5 3.75a2 2 0 1 0 0-4a2 2 0 0 0 0 4" clip-rule="evenodd" />
        <path fill="#7e56c2" fill-rule="evenodd" d="M3.752 33.583a165 165 0 0 1-.214-5.8c1.2 1.035 2.677 1.923 4.285 2.654C12.04 32.354 17.76 33.5 24 33.5s11.96-1.146 16.177-3.063c1.608-.731 3.085-1.62 4.285-2.654c-.046 2.328-.13 4.287-.214 5.8a113 113 0 0 1-.233 3.32l-.004.054l-.012.121c-.024 1.575-.777 2.956-1.88 4.085c-1.116 1.14-2.656 2.098-4.442 2.87C34.1 45.58 29.263 46.5 24 46.5s-10.1-.92-13.677-2.466c-1.786-.773-3.326-1.73-4.442-2.871c-1.103-1.128-1.856-2.51-1.88-4.084l-.017-.175l-.058-.692a124 124 0 0 1-.174-2.629M10.5 39.5a2 2 0 1 0 0-4a2 2 0 0 0 0 4m6.5 1.75a2 2 0 1 0 0-4a2 2 0 0 0 0 4" clip-rule="evenodd" />
    </svg>
    `,celery:`
    <svg viewBox="0 0 24 24">
        <path fill="#83a837"
            d="M2.303 0A2.3 2.3 0 0 0 0 2.303v19.394A2.3 2.3 0 0 0 2.303 24h19.394A2.3 2.3 0 0 0 24 21.697V2.303A2.3 2.3 0 0 0 21.697 0zm8.177 3.072c4.098 0 7.028 1.438 7.68 1.764l-1.194 2.55c-2.442-1.057-4.993-1.41-5.672-1.41c-1.574 0-2.17.922-2.17 1.763v8.494c0 .869.596 1.791 2.17 1.791c.679 0 3.23-.38 5.672-1.41l1.194 2.496c-.435.271-3.637 1.818-7.68 1.818c-1.112 0-4.64-.244-4.64-4.64V7.713c0-4.397 3.528-4.64 4.64-4.64z" />
    </svg>
    `,dagster:`
    ...
    <svg viewBox="0 0 256 256">
        <g fill="none">
            <g clip-path="url(#SVG5uOHZbSz)">
                <path fill="#654ff0"
                    d="M157.281 0v1.38c0 16.214-13.143 29.353-29.352 29.353c-16.213 0-29.352-13.143-29.352-29.353V0H0v256h256V0z" />
                <path fill="#fff"
                    d="M59.466 137.96h16.966l11.583 61.687h.209l13.921-61.687h15.87l12.574 62.444h.247l13.202-62.444h16.64l-21.622 90.641h-16.837l-12.47-61.687h-.326l-13.348 61.687h-17.15zm120.34 0h26.747l26.562 90.641h-17.502l-5.777-20.17h-30.469l-4.459 20.17h-17.046zm10.182 22.341l-7.4 33.255h23.032l-8.496-33.255z" />
            </g>
            <defs>
    ...
    <svg viewBox="0 0 24 24">
        <path fill="#F38B00"
            d="M12.654 9.988q.818.26 1.07 1.113v3.18h2.424v-.004h.373v-.006h.035V8.875q-.417-1.407-1.766-1.838H3.943q-1.35.43-1.766 1.838v11.343Q2.594 21.626 3.98 22h10.77q1.388-.374 1.805-1.782V17.26h-2.831v.712q-.253.853-1.093 1.08H6.104q-.84-.226-1.093-1.08V11.1q.252-.854 1.07-1.113z" />
        <path fill="#0095D3"
            d="M21.824 3.838Q21.407 2.43 20.057 2H9.212q-1.35.43-1.766 1.838v2.885h2.83v-.66q.254-.854 1.072-1.112h6.572q.818.258 1.07 1.112v6.873q-.252.853-1.093 1.08H11.37q-.84-.227-1.093-1.08V9.673H7.445v5.508q.418 1.407 1.804 1.782h10.77q1.388-.375 1.805-1.783z" />
    </svg>
    `,mql:`
    <svg viewBox="0 0 48 48">
        <circle
        ...
        <path
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M20.108 18.85c.01-.082.01-.165.01-.248v-2.37h7.764v2.37c0 .083 0 .166.01.249m.766-9.254a5.177 5.177 0 0 1 5.175 5.176v3.83a2.97 2.97 0 0 1-2.94 2.98m-13.786 0a2.98 2.98 0 0 1-2.94-2.98v-3.83a5.177 5.177 0 0 1 5.175-5.176"
            stroke-width="1.5"
        />
        <circle
            cx="9.658"
        ...
        <path
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M19.617 33.183a2 2 0 0 0-.22.115l-2.053 1.185l-3.881-6.723l2.053-1.185c.071-.042.143-.083.21-.133m-8.397 3.963a5.177 5.177 0 0 1 1.894-7.07l3.317-1.915a2.97 2.97 0 0 1 4.051 1.056m6.894 11.94a2.98 2.98 0 0 1-1.112 4.036l-3.317 1.915a5.177 5.177 0 0 1-7.07-1.894"
            stroke-width="1.5"
        />
        <circle
            cx="38.342"
        ...
        <path
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M32.274 26.442c.067.05.139.091.21.133l2.053 1.185l-3.881 6.723l-2.053-1.185q-.106-.065-.22-.116m7.63 5.291a5.177 5.177 0 0 1-7.07 1.894l-3.316-1.915a2.97 2.97 0 0 1-1.112-4.036m6.894-11.94a2.98 2.98 0 0 1 4.051-1.055l3.317 1.914a5.177 5.177 0 0 1 1.894 7.07M21.244 29.9c.621.52 1.224.758 2.73.758h.26a2.523 2.523 0 0 0 2.522-2.523h0a2.523 2.523 0 0 0-2.523-2.523h-2.99v-3.954h5.513"
            stroke-width="1.5"
        />
    </svg>
    `};document.querySelectorAll("skill").forEach(c=>{c.getAttribute("name")==null&&c.setAttribute("name",c.id),c.innerHTML=`
    <span class="block">
      <span class="${c.getAttribute("grade")}">
        ${icons[c.id.replaceAll(" ","_").toLowerCase()]}
        ${c.getAttribute("name")}
      </span>
    </span>
    `,c.replaceWith(c.querySelector("span"))});
